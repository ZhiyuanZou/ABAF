...
public class CrazyGeneral {
	...
	public CrazyGeneral(String fileName,String mypid) throws IOException{
		//TODO
	...
	public void exchangeV(){
		...
		String msg;
		if(temp > 1 - accuracy){
			msg = constructSingleMsg("exchangeV",pid,true);
		}else{
			msg = constructSingleMsg("exchangeV",pid,false);
		}
		broadcast(msg);
		report("exchangeV");
	}
...
//	}
	...
	public static void main(String[] args) {
		...
		try{
			...
			gg = new CrazyGeneral(args[0],args[1]);
		}catch(IOException e){
